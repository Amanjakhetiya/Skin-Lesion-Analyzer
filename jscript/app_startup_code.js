...
(async function () {
	...
	model = await tf.loadModel('https://stupefied-spence-7a6c28.netlify.app/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://stupefied-spence-7a6c28.netlify.app/assets/samplepic.jpg");
